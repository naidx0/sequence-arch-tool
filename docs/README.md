...
| [`site-modes-inventory.md`](site-modes-inventory.md) | The modes as the code has them, for trysequence.app copy |
...
| [`brand/marks/`](brand/marks/) | **Identity mark SoT** (Decision 26) — monochrome `sequence-mark.svg`; app plate + specimen |
| [`brand/MACOS-GRAPHITE-MEDIUM.md`](brand/MACOS-GRAPHITE-MEDIUM.md) | **UI CONTEXT DIET** — macOS liquid glass skinned on Graphite (Decision 20); read before chrome/CSS work |
