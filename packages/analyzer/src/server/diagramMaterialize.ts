/**
 * Materialize SystemBoard IR v0 → SeqDraw board items (analyzer copy of web2 draw/).
 */
import type { SystemBoardNode, SystemBoardV0 } from '@sequence/schema';

import type { BoardItem } from './boardTools.js';
import {
  layoutSystemBoard,
  nodeEdgeAnchor,
...
function legendItems(layout: SystemBoardLayout): BoardItem[] {
 ...
 */
export function materializeSystemBoard(board: SystemBoardV0): BoardItem[] {
