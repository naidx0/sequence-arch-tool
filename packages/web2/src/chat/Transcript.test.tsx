...
describe('item 2.5 — the two lanes', () => {
  it('gives the user a bubble on a surface token, inset from the right', () => {
    ...
    expect(resolvedStyle(bubble, 'background-color')).toBe(token('--user-bubble'));
...
describe('an answer containing code', () => {
  ...
  it('turns propose_topology JSON into Drawing architecture board theater when settled', () => {
    const dump =
    ...
    expect(theater.textContent).toMatch(/Drawing architecture board/);
  });
